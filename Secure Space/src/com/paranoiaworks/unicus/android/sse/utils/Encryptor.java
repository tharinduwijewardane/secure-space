...
public class Encryptor {
    ...
    public Encryptor(String password) throws NoSuchAlgorithmException, InvalidKeySpecException 
    {
    	this(password, BASE_ALGORITHM_CODE, false);
    }
    
    /** Encryptor with entered password and chosen algorithm */
    public Encryptor(String password, int algorithmCode) throws NoSuchAlgorithmException, InvalidKeySpecException 
    {
    	this(password, algorithmCode, false);
    }
    
    /** Encryptor with entered password, chosen algorithm and unicode character allowed */
    public Encryptor(String password, int algorithmCode, boolean unicodeAllowed) throws NoSuchAlgorithmException, InvalidKeySpecException 
    {
    ...
    public static Encryptor getDefaultTestEncryptor()
    {
	...
	public synchronized long zipAndEncryptFile(File inputFile, boolean compress, ProgressBarToken progressBarToken) throws IOException, InterruptedException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, InvalidAlgorithmParameterException, DataFormatException 
    {
		...
		if(inputFile.isFile()) {
			...
			long sizeCounter = this.zipDir(inputFile, zipOutputStream, BUFFER, compress, progressHandler);
	...
	private long zipSingleFile(File inputFile, ZipArchiveOutputStream zos, final int BUFFER, boolean compress, Handler progressHandler) throws IOException, InterruptedException
	{
